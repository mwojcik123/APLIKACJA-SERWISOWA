  ...
  render() {
    ...
    const work = item => (
      <TouchableOpacity
        ...
        <LinearGradient
          colors={['#a4c2f5', '#a4c2f5', '#eeeeee', '#eeeeee']}
          start={{x: 0, y: 0.5}}
          end={{x: 1, y: 0.5}}
          style={{
            flex: 1,
      ...
      <View
        ...
        <View style={styles.screen}>
          ...
          <View style={styles.calendarHeder}>
            ...
            <View>
              <Text style={styles.eventsTitle}>Twoje Naprawy</Text>
            </View>
            <View style={{flex: 1, width: 40}}>
          ...
          {!this.props.works_loading ? (
            <>
              <FlatList
                style={{width: width}}
                data={this.props.works_list_your}
                keyExtractor={item => item.id}
                bounces={false}
                refreshControl={
                  <RefreshControl
                    refreshing={this.props.refreshing_your}
                ...
                onEndReached={() => {
                  this.props.get_works_your_next_page();
                }}
              />
              {!this.props.works_list_your[0] ? (
...
const mapStateToProps = state => ({
  ...
  works_list_your: state.works.works_list_your,
  member_user: state.member.member_user,
  works_detail: state.works.works_detail,
  next_your: state.works.next_your,
