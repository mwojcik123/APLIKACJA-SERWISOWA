...
export class PartsMagazine extends Component {
  constructor(props) {
    console.log(props);
    super(props);
  ...
  static propTypes = {
    parts_list_avilable: PropTypes.array.isRequired,
  ...
  handleScroll = e => {
    ...
    if (offset >= contentHeight - scrollViewHeight) {
      e.preventDefault();
      this.props.get_parts_avilable_next_page();
    }
  };
  //   showModal3 = (data) => {
  ...
  render() {
    ...
    const {parts_detail, quantity, color, refreshingAvilable} = this.props;
      ...
      <View
        ...
        <View style={styles.screen}>
          ...
          <View style={styles.calendarHeder}>
            ...
            <View>
              <Text style={styles.eventsTitle}>Części w Magazynie</Text>
            </View>
            <View style={{flex: 1, width: 40}}>
          ...
          <View style={{flex: 1}}>
            ...
            <FlatList
              style={{width: width}}
              data={this.props.parts_list_avilable}
              keyExtractor={item => item.id}
              bounces={false}
              refreshControl={
                <RefreshControl
                  refreshing={refreshingAvilable}
        ...
        <RBSheet
          ...
          <View style={styles.sheetHeader}>
              ...
              {parts_detail.catalog_id ? (
                <TouchableOpacity onPress={this.Back}>
                  <View style={{width: 60, alignItems: 'flex-end'}}>
                    <Text style={styles.close}>Odeślij</Text>
                  </View>
                </TouchableOpacity>
              ) : null}
            </View>
            ...
            {parts_detail.catalog_id ? (
              ...
              <TouchableOpacity onPress={() => this.sheet.current.close()}>
                <View style={{width: 60, alignItems: 'flex-end'}}>
...
const mapStateToProps = state => ({
  parts_list_avilable: state.parts.parts_list_avilable,
  ...
  refreshingAvilable: state.parts.refreshingAvilable,
});
