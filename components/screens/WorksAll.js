...
export class Works extends Component {
  ...
  static propTypes = {
    works_list_all: PropTypes.object.isRequired,
      ...
      <View
        ...
        <View style={styles.screen}>
          ...
          <View style={styles.calendarHeder}>
            ...
            <View>
              <Text style={styles.eventsTitle}>Wszystkie Naprawy</Text>
            </View>
            <View style={{flex: 1, width: 40}}>
          ...
          {!this.props.works_loading ? (
            <>
              <FlatList
                style={{width: width}}
                data={this.props.works_list_all}
                keyExtractor={item => item.id}
                bounces={false}
                refreshControl={
                  <RefreshControl
                    refreshing={this.props.refreshing_all}
                ...
                onEndReached={() => {
                  this.props.get_works_all_next_page();
                }}
              />
              {!this.props.works_list_all[0] ? (
